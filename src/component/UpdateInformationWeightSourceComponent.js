...
export const UpdateInformationWeightSourceComponent = Form.create()(
        ...
        render() {
            ...
            if (initData !== undefined && initData !== null) {
                for (let key in initData) {
                    ...
                    } else if (key === 'weight_source_id') {
                        var weightSourceIdInit = initData[key];
                    }
                }
            ...
            return (
                <Modal
                    ...
                    <Form layout='vertical'>
                        ...
                        <FormItem label='权重源id'>
                            { getFieldDecorator('weight_source_id', {
                                initialValue: weightSourceIdInit,
                                rules: [{
                                    required: true,
                                    message: '请输入滤非法结果id'
                                }]
