...
class InformationRepetitionResultContainer extends Component {
    ...
    handleDelete(informationRepetitionResultId) {
        const { dispatch } = this.props;
        // 提交删除请求
        dispatch(fetchDeleteInformationRepetitionResult(informationRepetitionResultId));
    ...
    handleUpdate() {
        ...
        form.validateFields((err, values) => {
            ...
            // 提交更新请求
            dispatch(fetchUpdateInformationRepetitionResult(repetitionResultId, formData));
