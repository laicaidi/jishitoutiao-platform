...
export const UpdateInformationRepetitionResultComponent = Form.create()(
        ...
        render() {
            ...
            if (initData !== undefined && initData !== null) {
                for (let key in initData) {
                    ...
                    } else if (key === 'repetition_result_id') {
                        var repetitionResultIdInit = initData[key];
                    }
                }
            ...
            return (
                <Modal
                    ...
                    <Form layout='vertical'>
                        ...
                        <FormItem label='滤重结果id'>
                            { getFieldDecorator('repetition_result_id', {
                                initialValue: repetitionResultIdInit,
                                rules: [{
                                    required: true,
                                    message: '请输入滤重结果id'
                                }]
