...
export const UpdateInformationOutputListComponent = Form.create()(
        ...
        render() {
            ...
            if (initData !== undefined && initData !== null) {
                for (let key in initData) {
                    ...
                    } else if (key === "output_list_id") {
                        var outputListIdInit = initData[key];
                    }
                }
            ...
            return (
                <Modal
                    ...
                    <Form layout="vertical">
                        ...
                        <FormItem label="列表输出id">
                            { getFieldDecorator('output_list_id', {
                                initialValue: outputListIdInit,
                                rules: [{
                                    required: true,
                                    message: "请输入得分数据id"
                                }]
