...
"[project]/app/information-weight-set/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Page() {
    ...
    const fetchList = async ()=>{
        try {
            setLoading(true);
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getInformationWeightSetApi"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$security$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["safeInput"])(keyword), pageNum);
    ...
    const handleAdd = async ()=>{
        try {
            ...
            setAddLoading(true);
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addInformationWeightSetApi"])({
                wkey: (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$security$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["safeInput"])(params.wkey),
    ...
    const handleEdit = async ()=>{
        try {
            ...
            setEditLoading(true);
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateInformationWeightSetApi"])(params.sid, {
                wkey: (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$security$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["safeInput"])(params.wkey),
                wvalue: Number(params.wvalue),
                remark: (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$security$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["safeInput"])(params.remark || '')
            });
    ...
    const handleDeleteConfirm = async (record)=>{
        try {
            ...
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteInformationWeightSetApi"])(record.sid);
            const msg = res.data?.status?.message;
            if (res.data?.status?.success) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$antd$40$6$2e$3$2e$7_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success(msg);
                handleSearch();
...
//# sourceMappingURL=_0j6vuft._.js.map