...
export function fetchGetAllInformationIllegalitySet(keyword, pageNum) {
    return function(dispatch, getState) {
        ...
        // 拼接请求url
        var url = "/jishitoutiao-server/informationillegalityset/";        // 请求url
...
export function fetchAddInformationIllegalitySet(formData) {
    return function(dispatch, getState) {
        ...
        var url = "/jishitoutiao-server/informationillegalityset/";
        var myInit = {
            method: "POST",
            mode: 'cors',       // 允许跨域发送请求
            headers: {
...
export function fetchDeleteInformationIllegalitySet(id) {
    return function(dispatch, getState) {
        ...
        var url =`/jishitoutiao-server/informationillegalityset/${id}`
        var myInit = {
            method: "DELETE",
            mode: 'cors',       // 允许跨域发送请求
            headers: {
