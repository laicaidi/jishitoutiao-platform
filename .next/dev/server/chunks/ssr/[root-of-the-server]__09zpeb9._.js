...
"[project]/app/crawler-category/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Page() {
    ...
    const fetchList = async ()=>{
        try {
            setLoading(true);
            // 调用查询接口，传入搜索关键词 + 当前页码
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCrawlerCategoryApi"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$security$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["safeInput"])(keyword), pageNum);
            // 设置表格数据
    ...
    const handleAdd = async ()=>{
        try {
            ...
            setAddLoading(true);
            // 3. 调用新增接口
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addCrawlerCategoryApi"])({
                ckey: (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$security$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["safeInput"])(params.ckey),
                cname: (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$security$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["safeInput"])(params.cname),
    ...
    const handleEdit = async ()=>{
        try {
            ...
            setEditLoading(true);
            // 3. 调用编辑接口（必须传入 cid）
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateCrawlerCategoryApi"])(params.cid, {
                ckey: (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$security$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["safeInput"])(params.ckey),
                cname: (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$security$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["safeInput"])(params.cname),
                remark: (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$security$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["safeInput"])(params.remark || '')
            });
    ...
    const handleDeleteConfirm = async (record)=>{
        try {
            ...
            // 调用删除接口
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteCrawlerCategoryApi"])(record.cid);
            const msg = res.data?.status?.message;
            if (res.data?.status?.success) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$antd$40$6$2e$3$2e$7_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success(msg);
                // ==================== 统一刷新：重置页码1 + 携带搜索词 ====================
...
//# sourceMappingURL=%5Broot-of-the-server%5D__09zpeb9._.js.map