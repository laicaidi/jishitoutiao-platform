...
export function fetchGetAllInformationOutputArticle(keyword, pageNum, bkey, ckey) {
    return function(dispatch, getState) {
        ...
        // 拼接url请求
        var url = "/jishitoutiao-server/informationoutputarticle/"
...
export function fetchDeleteInformationOutputArticle(id) {
    return function(dispatch, getState) {
        ...
        var url =`/jishitoutiao-server/informationoutputarticle/${id}`
        var myInit = {
            method: "DELETE",
            mode: 'cors',       // 允许跨域发送请求
            headers: {
...
export function fetchUpdateInformationOutputArticle(id, formData) {
    return function(dispatch, getState) {
        ...
        console.log("--------------fetchUpdateInformationOutputArticle id: " + id);
