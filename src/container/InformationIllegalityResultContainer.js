...
class InformationIllegalityResultContainer extends Component {
    ...
    handleDelete(informationIllegalityResultId) {
        const { dispatch } = this.props;
        // 提交删除请求
        dispatch(fetchDeleteInformationIllegalityResult(informationIllegalityResultId));
    }
    ...
    handleUpdate() {
        ...
        form.validateFields((err, values) => {
            ...
            // 提交更新请求
            dispatch(fetchUpdateInformationIllegalityResult(illegalityResultId, formData));
